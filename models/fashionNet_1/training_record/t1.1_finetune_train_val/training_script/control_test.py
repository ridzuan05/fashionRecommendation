...
net = caffe.Net('/local2/home/tong/fashionRecommendation/models/fashionNet_1/fashion_deploy_1.prototxt', caffe.TEST)

# solver
solver = caffe.SGDSolver('/local2/home/tong/fashionRecommendation/models/fashionNet_1/training_record/t1.1_finetune_train_val/solver_prototxt/fashion_solver_1_k/fashion_solver_1_'+tUID+'.prototxt')

# caffemodel
caffemodel_path = '/local2/home/tong/fashionRecommendation/models/fashionNet_1/training_record/t1.1_train_val/fashion_params_1_'+cID+'.caffemodel'
solver.net.copy_from(caffemodel_path)
solver.test_nets[0].copy_from(caffemodel_path)

# results folder
recordDir = '/local2/home/tong/fashionRecommendation/models/fashionNet_1/training_record/t1.1_finetune_train_val/training_script/results/'
recordDir_data = recordDir+'data/'+test_fd+'/'

if 'results' not in os.listdir('/local2/home/tong/fashionRecommendation/models/fashionNet_1/training_record/t1.1_finetune_train_val/training_script/'):
