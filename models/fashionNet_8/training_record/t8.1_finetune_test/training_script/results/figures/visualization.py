...
root = '/local2/home/tong/fashionRecommendation/models/fashionNet_8/training_record/t8.1_finetune_test/'
...
ax_left.plot(top_k_idx, cmp_top_k_optimal, ':y', label = 'usf', LineWidth = 3)
ax_left.plot(top_k_idx, cmp_top_k_initial, '.c', label = 'nf', LineWidth = 3)
...
cmp_top_k_optimal_temp = str(cmp_top_k_optimal[0])
...
for f in range(1,len(top_k_idx)):
	...
	cmp_top_k_optimal_temp += ' '+str(cmp_top_k_optimal[f])
...
top_k_posi_num_fp.write(cmp_top_k_optimal_temp+'\r\n')
...
ax_left.plot(ndcg_at_idx, cmp_optimal_ndcg_at, ':y', label = 'usf', LineWidth = 3)
ax_left.plot(ndcg_at_idx, cmp_initial_ndcg_at, '.c', label = 'nf', LineWidth = 3)
lines_left, labels_left = ax_left.get_legend_handles_labels()   
ax_left.legend(lines_left, labels_left, loc=0)
ax_left.grid()
...
cmp_optimal_ndcg_at_temp = str(cmp_optimal_ndcg_at[0])
...
for f in range(1,len(ndcg_at_idx)):
	...
	cmp_optimal_ndcg_at_temp += ' '+str(cmp_optimal_ndcg_at[f])
...
new_finetune_ndcg_at_fp.write(cmp_optimal_ndcg_at_temp+'\r\n')
...
best_root = '/local2/home/tong/fashionRecommendation/models/fashionNet_8/training_record/t8.1_finetune_test/training_script/results/figures/charts/best/'
best_u_count = 0
flag_n = 0
...
worst_root = '/local2/home/tong/fashionRecommendation/models/fashionNet_8/training_record/t8.1_finetune_test/training_script/results/figures/charts/worst/'
worst_u_count = 0
flag_n = 0
