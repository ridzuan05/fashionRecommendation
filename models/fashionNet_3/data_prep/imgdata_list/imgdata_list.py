g_root = "/local2/home/tong/fashionRecommendation/models/fashionNet_3/data_prep/"
...
for i in range(0,len(data_type)):
	for j in range(0,len(attr_type)):
		for k in range(0,len(item_type)):
			...
			imgData_target = open(g_root+"imgdata_list/"+data_type[i]+attr_type[j]+item_type[k])
