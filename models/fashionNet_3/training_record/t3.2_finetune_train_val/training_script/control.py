...
# results folder
recordDir = '/local2/home/tong/fashionRecommendation/models/fashionNet_3/training_record/t3.2_finetune_train_val/training_script/results/'
recordDir_data = recordDir+'data/U_'+uID+'/'

if 'results' not in os.listdir('/local2/home/tong/fashionRecommendation/models/fashionNet_3/training_record/t3.2_finetune_train_val/training_script/'):
...
# solver
solver = caffe.SGDSolver('/local2/home/tong/fashionRecommendation/models/fashionNet_3/training_record/t3.2_finetune_train_val/solver_prototxt/fashion_solver_3_k/fashion_solver_3_'+uID+'.prototxt')
