...
# source folder
recordDir0 = '/home/dell/fashionRecommendation/models/fashionNet_9/training_record/t9.2_finetune_train_val/training_script/results/'
recordDir_data0 = recordDir0+'data/U_'+uID+'/'

# results folder
recordDir = '/home/dell/fashionRecommendation/models/fashionNet_9/training_record/t9.2_finetune_test/training_script/results/'
recordDir_data = recordDir+'data/U_'+uID+'/'

if 'results' not in os.listdir('/home/dell/fashionRecommendation/models/fashionNet_9/training_record/t9.2_finetune_test/training_script/'):
...
# solver
solver = caffe.SGDSolver('/home/dell/fashionRecommendation/models/fashionNet_9/training_record/t9.2_finetune_test/solver_prototxt/fashion_solver_9_k/fashion_solver_9_'+uID+'.prototxt')
