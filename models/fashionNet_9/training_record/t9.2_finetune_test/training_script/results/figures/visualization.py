...
root = '/home/dell/fashionRecommendation/models/fashionNet_9/training_record/t9.2_finetune_test/'
...
optimal_initial_mean_ndcg_fp.write(str(optimal_mean_ndcg)+'\r\n')
# optimal_initial_mean_ndcg_fp.write(str(cmp_optimal_mean_ndcg)+' '+str(cmp_initial_mean_ndcg)+' '+str(cmp_gain)+'\r\n')
# optimal_initial_mean_ndcg_fp.write(str(cmp_initial_mean_ndcg)+'\r\n')
...
top10_posi_num_fp.write(str(optimal_top10_posi_num)+'\r\n')
...
path_root = '/home/dell/fashionRecommendation/models/fashionNet_8/data_prep/imgdata_list/tvt_pn_tbs_k_txt/test_'

# retrieve best top_10 outfits for 4 users
best_root = '/home/dell/fashionRecommendation/models/fashionNet_9/training_record/t9.2_finetune_test/training_script/results/figures/charts/best/'
best_u_count = 0
flag_n = 0
...
worst_root = '/home/dell/fashionRecommendation/models/fashionNet_9/training_record/t9.2_finetune_test/training_script/results/figures/charts/worst/'
worst_u_count = 0
flag_n = 0
