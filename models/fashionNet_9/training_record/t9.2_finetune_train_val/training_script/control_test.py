...
net = caffe.Net('/home/dell/fashionRecommendation/models/fashionNet_9/fashion_deploy_9.prototxt', caffe.TEST)
...
# results folder
recordDir = '/home/dell/fashionRecommendation/models/fashionNet_9/training_record/t9.2_finetune_train_val/training_script/results/'
recordDir_data = recordDir+'data/'+test_fd+'/'

if 'results' not in os.listdir('/home/dell/fashionRecommendation/models/fashionNet_9/training_record/t9.2_finetune_train_val/training_script/'):
