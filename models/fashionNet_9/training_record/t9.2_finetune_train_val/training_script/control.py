...
# solver
solver = caffe.SGDSolver('/home/dell/fashionRecommendation/models/fashionNet_9/training_record/t9.2_finetune_train_val/solver_prototxt/fashion_solver_9_k/fashion_solver_9_'+uID+'.prototxt')
