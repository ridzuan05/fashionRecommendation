...
# source folder
recordDir0 = '/local2/home/tong/fashionRecommendation/models/fashionNet_9/training_record/t9.1_finetune_train_val/training_script/results/'
recordDir_data0 = recordDir0+'data/U_'+uID+'/'

# results folder
recordDir = '/local2/home/tong/fashionRecommendation/models/fashionNet_9/training_record/t9.1_finetune_test/training_script/results/'
recordDir_data = recordDir+'data/U_'+uID+'/'

if 'results' not in os.listdir('/local2/home/tong/fashionRecommendation/models/fashionNet_9/training_record/t9.1_finetune_test/training_script/'):
...
# solver
solver = caffe.SGDSolver('/local2/home/tong/fashionRecommendation/models/fashionNet_9/training_record/t9.1_finetune_test/solver_prototxt/fashion_solver_9_k/fashion_solver_9_'+uID+'.prototxt')
...
for c in range(0,2):
    ...
    if (c%2==0):
        ...
        caffemodel_path = recordDir_data0+'fashion_params_9_'+cID[c]+'.caffemodel'
    elif (c==3):
        caffemodel_path = recordDir_data0+'cmp_fashion_params_9_'+cID[c]+'.caffemodel'
