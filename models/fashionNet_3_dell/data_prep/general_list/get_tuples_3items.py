...
#    get_img_info(unique_images, list_shoe, fn_shoe_descr, "description", 1)    
    ...
    train_val_test_devision = [0,201,202,247,248,309]
...
###testing dataset
    ...
    dict_tops_test, dict_bottoms_test, dict_shoes_test, n_posi_tuples_test = get_positive_tuples(
        all_tuples, train_val_test_devision[4],train_val_test_devision[5],
        list_top, list_bottom, list_shoe,
        all_sets, user_ids, all_setids,
...
def get_positive_tuples(all_tuples, start_idx, end_idx, list_top, list_bottom, list_shoe,
                        all_sets, user_ids, all_setids,
    ...
    for i in range(len(all_tuples)): #for each users
        start_tuple_idx = start_idx
        end_tuple_idx = end_idx
        for j in range(start_tuple_idx, end_tuple_idx+1):
