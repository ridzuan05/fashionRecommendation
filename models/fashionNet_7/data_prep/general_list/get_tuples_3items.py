...
def get_all_tuples(all_sets, unique_images, minimum_sets_num):
    ...
    fn_top = '/local2/home/tong/fashionRecommendation/models/fashionNet_7/data_prep/general_list/img_list_top.txt'
    fn_bottom = '/local2/home/tong/fashionRecommendation/models/fashionNet_7/data_prep/general_list/img_list_bottom.txt'
    fn_shoe = '/local2/home/tong/fashionRecommendation/models/fashionNet_7/data_prep/general_list/img_list_shoe.txt'
...
#                    "tuple_90", "tuple_135", "tuple_180"]            
    ...
    sub_folder = '/local2/home/tong/fashionRecommendation/models/fashionNet_7/data_prep/general_list/'
    ...
    fn_tuples_train_posi_mid = sub_folder+'tuples_train_posi_mid.txt'
    ...
    fn_tuples_val_posi_mid = sub_folder+'tuples_val_posi_mid.txt'
    ...
    fn_tuples_test_posi_mid = sub_folder+'tuples_test_posi_mid.txt'
...
###training dataset
    ...
    get_negative_tuples2(user_ids, len(dict_tops_train),
                         ...
                         fn_tuples_train_neg, fn_tuples_train_posi_mid, fn_tuples_train_posi, n_posi_tuples_train,ratio)
...
###validation dataset
    ...
    get_negative_tuples2(user_ids, len(dict_tops_val),
                         ...
                         fn_tuples_val_neg, fn_tuples_val_posi_mid, fn_tuples_val_posi, n_posi_tuples_val,ratio)
...
###testing dataset
    ...
    get_negative_tuples2(user_ids, len(dict_tops_test),
                         ...
                         fn_tuples_test_neg, fn_tuples_test_posi_mid, fn_tuples_test_posi, n_posi_tuples_test,ratio)
...
def get_positive_tuples(all_tuples, start_percent, end_percent, list_top, list_bottom, list_shoe,
                        all_sets, user_ids, all_setids,
                        fn_top_ind, fn_bottom_ind, fn_shoe_ind,
                        fn_tuples,
                        ratio):
...
def get_negative_tuples2(user_ids, num_top, num_bottom, num_shoe,
                         fn_tuples_neg, fn_tuples_mid, fn_tuples_posi, n_posi_tuples,ratio):
    ...
    fid = open(fn_tuples_neg, 'w') # open tuples_neg.txt
    fid_mid = open(fn_tuples_mid, 'w') # open tuples_posi_mid.txt
    for i in range(len(user_ids)): #for each valid user i
        ...
        for k in range(n_neg_tuples): #for each nega tuple
            if (k % neg_posi_ratio == 0):
                set_idx = int(k / neg_posi_ratio)
                set_idx = int((set_idx + 1) % n_posi_tuples[i])
                fid_mid.write('%d %d %d %d\n' % (posi_tuples[i][set_idx][0], posi_tuples[i][set_idx][1], 
                                             posi_tuples[i][set_idx][2], posi_tuples[i][set_idx][3]))
            elif (k % neg_posi_ratio == 1):
                set_idx = int(k / neg_posi_ratio)
                set_idx = int((set_idx + 2) % n_posi_tuples[i])
                fid_mid.write('%d %d %d %d\n' % (posi_tuples[i][set_idx][0], posi_tuples[i][set_idx][1], 
                                             posi_tuples[i][set_idx][2], posi_tuples[i][set_idx][3]))
            elif (k % neg_posi_ratio == 2):
                set_idx = int(k / neg_posi_ratio)
                set_idx = int((set_idx + 3) % n_posi_tuples[i])
                fid_mid.write('%d %d %d %d\n' % (posi_tuples[i][set_idx][0], posi_tuples[i][set_idx][1], 
                                             posi_tuples[i][set_idx][2], posi_tuples[i][set_idx][3]))
            else:
