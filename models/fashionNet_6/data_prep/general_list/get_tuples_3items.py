...
def get_all_tuples(all_sets, unique_images, minimum_sets_num):
    ...
    fn_top = '/local2/home/tong/fashionRecommendation/models/fashionNet_6/data_prep/general_list/img_list_top.txt'
    fn_bottom = '/local2/home/tong/fashionRecommendation/models/fashionNet_6/data_prep/general_list/img_list_bottom.txt'
    fn_shoe = '/local2/home/tong/fashionRecommendation/models/fashionNet_6/data_prep/general_list/img_list_shoe.txt'
...
#                    "tuple_90", "tuple_135", "tuple_180"]            
    ...
    sub_folder = '/local2/home/tong/fashionRecommendation/models/fashionNet_6/data_prep/general_list/'
    ...
    fn_tuples_train_neg = sub_folder+'tuples_train_posi_neg.txt'
    ###validation dataset
    ...
    fn_tuples_val_neg = sub_folder+'tuples_val_posi_neg.txt'
    ###testing dataset
    ...
    fn_tuples_test_neg = sub_folder+'tuples_test_posi_neg.txt'
...
def get_negative_tuples2(user_ids, num_top, num_bottom, num_shoe,
    ...
    with open(fn_tuples_posi, 'r') as f: #open tuples_train_posi.txt
        ...
        for line in f: #for each posi train tuple (user id, inter top id, inter bot id, inter sho id)
            ...
            sub_posi_tuples.append([tpl[0], tpl[1], tpl[2], tpl[3]])
    posi_tuples.append(sub_posi_tuples)
